...
class ResourceMapperTests extends GrailsUnitTestCase {
    ...
    void testDefaultIncludesExcludes() {
        ...
        def m = new ResourceMapper(artefact, [foobar:[:]] as ConfigObject)
    ...
    void testResourceExclusionOfMapper() {
        ...
        def m = new ResourceMapper(artefact, [minify:[:]] as ConfigObject)
        ...
        def m2 = new ResourceMapper(artefact2, [other:[:]] as ConfigObject)

        def testMeta = new ResourceMeta()
        testMeta.sourceUrl = '/images/test.png'
        testMeta.actualUrl = '/images/test.png'
        testMeta.contentType = "image/png"
        testMeta.excludedMappers = ['minify']
