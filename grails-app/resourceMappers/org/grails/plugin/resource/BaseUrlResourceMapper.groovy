...
class BaseUrlResourceMapper {
    ...
    static MapperPhase phase = MapperPhase.ABSOLUTISATION
    ...
    void verifySameBaseUrlForAllModulesInBundle(AggregatedResourceMeta bundle, Map config) {
        ...
        List uniqueUrls = baseUrlsForBundleModules.values().unique(false)
        if (uniqueUrls.size() != 1) {
            String bundleName = bundle.resources.first().bundle
